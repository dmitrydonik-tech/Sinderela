...
```bash
node tests/check-site.mjs      # ожидаем: ✅ Пройдено: 37
```
...
## Правило
После любой правки `index.html`: все тесты зелёные (check-site 37/0, pricing 41/41, icons, i18n) + рендер в светлой и тёмной теме.
