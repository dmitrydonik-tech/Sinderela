...
```bash
node tests/check-site.mjs      # ожидаем: ✅ Пройдено: 35
```
...
## Правило
После любой правки `index.html`: все тесты зелёные (check-site 35/0, pricing 41/41, icons, i18n) + рендер в светлой и тёмной теме.
